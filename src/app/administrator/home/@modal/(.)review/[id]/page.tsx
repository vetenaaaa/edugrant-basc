        ...
        <div className="grid grid-cols-3 overflow-auto no-scrollbar">
          ...
          <div className="col-span-2 p-4 space-y-3">
            <div className="flex justify-between items-center">
              <h1 className="text-green-700">Submitted Documents</h1>
            ...
            <div className="grid grid-cols-2 gap-3">
              {data?.userDocuments &&
                Object.entries(data.userDocuments).map(([key, doc]) => (
                  <div
                    key={key}
                    className=" aspect-square bg-background rounded-md flex flex-col p-4 gap-4"
                  >
                    <div className="flex-1  bg-card rounded-md flex flex-col gap-5 justify-center items-center">
                      ...
                      <div className="text-center flex flex-col items-center gap-2">
                        ...
                        <Badge className="bg-blue-800 text-gray-200">
                          {doc.fileFormat === "jpg" ? "Image" : "Document"}
                        </Badge>
                      </div>
                    </div>
