...
export default function LoginAdmin() {
  ...
  return (
    <div className="relative h-screen">
      ...
      <div className=" flex justify-center items-center h-full w-full  bg-[radial-gradient(circle,_rgb(0,0,0,1)_0%,_rgb(0,0,0,0)_100%)]">
...
"
        ...
        <div className="border border-[var(--eclipse)] h-[80%]"></div>
        <div className="flex-1 flex flex-col justify-center items-center">
...
//       <div className="absolute inset-0 z-50 bg-[radial-gradient(circle,_rgb(0,0,0,1)_0%,_rgb(0,0,0,0)_100%)] flex justify-center items-center">
//         <div className="w-sm space-y-6">
//           <div>
//             <h1 className="text-xl font-semibold">Edugrant Admin</h1>
